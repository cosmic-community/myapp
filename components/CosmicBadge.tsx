...
export default function CosmicBadge({ bucketSlug }: { bucketSlug: string }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 left-5 flex items-center gap-2 text-white text-sm font-medium no-underline transition-colors duration-200 z-50"
      style={{
        position: 'fixed',
    ...
    >
      <button
        ...
        className="absolute -top-2 -left-2 w-6 h-6 bg-gray-600 hover:bg-gray-700 text-white rounded-full flex items-center justify-center text-sm font-bold transition-colors duration-200 z-10"
        aria-label="إغلاق"
      >
        ×
      </button>
